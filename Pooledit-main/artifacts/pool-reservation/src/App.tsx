...
const Reservations = lazy(() => import("@/pages/member/reservations").then((m) => ({ default: m.Reservations })));
const Book = lazy(() => import("@/pages/member/book").then((m) => ({ default: m.Book })));
const Calendar = lazy(() => import("@/pages/member/calendar").then((m) => ({ default: m.Calendar })));
const MemberInstructors = lazy(() => import("@/pages/member/instructors").then((m) => ({ default: m.MemberInstructors })));
const InstructorSchedule = lazy(() => import("@/pages/instructor/schedule").then((m) => ({ default: m.InstructorSchedule })));
const MembershipCard = lazy(() => import("@/pages/member/membership-card").then((m) => ({ default: m.MembershipCard })));
const Profile = lazy(() => import("@/pages/member/profile").then((m) => ({ default: m.Profile })));
const WalletPage = lazy(() => import("@/pages/member/wallet").then((m) => ({ default: m.WalletPage })));
const Topup = lazy(() => import("@/pages/member/topup").then((m) => ({ default: m.Topup })));
const Packages = lazy(() => import("@/pages/member/packages").then((m) => ({ default: m.Packages })));
const Products = lazy(() => import("@/pages/member/products").then((m) => ({ default: m.Products })));
const Services = lazy(() => import("@/pages/member/services").then((m) => ({ default: m.Services })));
